...
// [dimes, remainder] = DimeCounter(remainder);
// [nickels, remainder] = NickelCounter(remainder);
// [pennies, remainder] = PennyCounter(remainder);

let coins = {};
let price = 4.99;
let denominations = [.25, .1, .05, .01];
denominations.forEach(value =>{
  [numberOfCoins, price] = coin(value)(price);
